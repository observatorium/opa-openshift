...
require (
	...
	github.com/openshift/client-go v0.0.0-20241107164952-923091dd2b1a // release-4.18
	github.com/openshift/telemeter v0.0.0-20241113134001-700802fe29ab // release-4.18
